...
if %ERRORLEVEL% EQU 1060 (
  echo.
  echo 无法检测到 Office ClickToRun 服务……
  goto :end
)

if not exist "%_LicPath%\*.xrm-ms" (
  echo.
  echo 无法检测到 Office 2016 授权文件……
  goto :end
)

if %_WinBuild% LSS 9200 if not exist "%_OSPP%" (
  echo.
  echo 无法检测到授权工具 OSPP.VBS……
  goto :end
)
::=============================================================
:Check
